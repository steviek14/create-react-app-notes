...
export default class LikeButton extends React.Component{ //React.Component is a React class we can extend to create our own components 
    render(){ //render method determines what the component will look like as HTML on the app 
        return React.createElement('button', {class: 'btn btn-primary'}, 'Like') //takes 3 arguments: what html element you want to create, props object, content/children of the element thats going to be rendered 
    }
}
...
//    render(){ 
//      return <button className="btn btn-primary">Like</button>; //converting React.createElement to JSX 
//        
//}